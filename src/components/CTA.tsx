    ...
    <section className="py-20 md:py-28 bg-white border-t border-foundy-border">
      <div className="container text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href={`https://wa.me/6282258877977?text=${encodeURIComponent("Hello, I'm interested in Foundy Works")}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#25D366] text-white font-medium text-base rounded-lg hover:bg-[#22c35e] transition-colors"
          >
